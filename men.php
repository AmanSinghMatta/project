...
<body style="margin: 0; padding: 0; box-sizing: border-box;">
        ...
        <div class="row mx-5">
            <div class="col-md-7">
                <div class="container" data-aos="fade-up" data-aos-offset="200" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false">
                    ...
                    $query = 'SELECT * FROM men ORDER by id ASC';
                    ...
                    ?>
                                <div class="container">
                                    ...
                                    <div class="col-sm-3 col-md-3">
                                        <form method="post" action="men.php?action=add&id=<?php echo $product['id']; ?>">
                                            <div class="product">
                        ...
                        <table class="table">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><a href="men.php?action=delete&id=<?php echo $product['id']; ?>">
    ...
    <form class="mbr-form" action="/" method="post" data-form-title="Mobirise Form">
        ...
        <input type="text" class="form-control" name="coupon" required placeholder="coupon code" id="coupon" />
