...
<body>
    <div>
        ...
        <div class="row mx-5">
            <div class="col-md-7">
                <div class="container-fluid" data-aos="fade-up" data-aos-offset="200" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false">
                    <?php
                    ...
                    ?>
                                <div class="container-fluid">
                                    <div class="col-md-5">
                                        <form method="post" action="jackets.php?action=add&id=<?php echo $product['id']; ?>">
                                            <div class="product">
                                                <img style="height: 350px; width: 300px; border: 5px; border-color: black;" src="<?php echo $product['image']; ?>" class="img-responsive my-5" />
