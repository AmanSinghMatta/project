...
if (isset($_POST["add_to_cart"])) {
    if (isset($_SESSION["wfh"])) {
        ...
        if (!in_array($_GET["id"], $item_array_id)) {
            ...
            echo '<script>window.location="wfh.php"</script>';
        }
    } else {
        $item_array = array(
            'id' => $_GET["id"],
...
<head>
    ...
    <title>Work from Home Collection</title>
    <style></style>
</head>
        ...
        <div class="row mx-5">
            <div class="col-md-7">
                <div class="container" data-aos="fade-up" data-aos-offset="200" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false">
                    ...
                    $query = 'SELECT * FROM wfh ORDER by id ASC';
                    ...
                    ?>
                                <div class="container">
                                    ...
                                    <div class="col-sm-3 col-md-3">
                                        <form method="post" action="wfh.php?action=add&id=<?php echo $product['id']; ?>">
                                            <div class="product">
                        ...
                        <table class="table">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><a href="wfh.php?action=delete&id=<?php echo $product['id']; ?>">
